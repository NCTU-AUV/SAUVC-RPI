...
with the STM32 board: `./rpi_ros2_ws/scripts/start_micro_ros_agent.sh`.
5. Flash the binary to the STM32 so that it restarts: `./rpi_ros2_ws/scripts/flash_stm32.sh`.
